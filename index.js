...
function showProduk(produkID) {
    ...
    // --- START PERUBAHAN UNTUK MENGARAHKAN KE SERLOK.HTML ---
    const btnBeliSekarang = document.getElementById('btn-beli-sekarang');
    if (btnBeliSekarang) {
        // Hapus event listener lama
        btnBeliSekarang.onclick = null; 
        
        // Tambahkan event listener baru untuk mengarahkan ke serlok.html
        btnBeliSekarang.onclick = function() {
            window.location.href = 'https://nasukafoods.site/serlok.html';
        };
    }
