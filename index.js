...
document.getElementById("cariUser").addEventListener("input", function () {  
  ...
  <div style="display:flex;gap:6px;margin-top:6px">
    ...
    <textarea id="inputKomentar-${postId}" placeholder="Tulis komentar..." style="flex:1;padding:6px;border:1px solid #ccc;border-radius:6px;font-size:13px;resize:none" rows="3"></textarea>
