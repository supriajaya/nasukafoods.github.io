...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateOnline() {
    ...
    else if (hour >= 12 && hour < 14) base = 290 + Math.floor(Math.random() * 20);
    else if (hour >= 14 && hour < 17) base = 310 + Math.floor(Math.random() * 40);
    else if (hour >= 17 && hour < 20) base = 470 + Math.floor(Math.random() * 50);
    else if (hour >= 20 && hour < 23) base = 650 + Math.floor(Math.random() * 50);
