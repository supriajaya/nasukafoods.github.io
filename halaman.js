function showHalaman(halamanId) {
  const halamans = ['home','profil','editprofil','saya','belanja','payment','burung','roll','labirin','puzzle','rule','disclaimer','leaderboard','faq','return','privacy','term','pasar','zona1','zona2']; 
