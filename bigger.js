...
function showCross() {
    ...
    document.getElementById('gameBody').classList.add('cross-bg');
     ...
     <script src="https://nasukafoods.site/halaman-multi.js"></script>
     
          <script src="function showHome() {
    document.getElementById('home-container').style.display = 'block';
    document.getElementById('profil-container').style.display = 'none';
    document.getElementById('payment-container').style.display = 'none';
    document.getElementById('editprofil-container').style.display = 'none';
...
const firebaseConfig = { apiKey: "AIzaSyASa57fEz1c31GwQ_1SR0UyLPbWOEuk8vs", authDomain: "nasukaapp.firebaseapp.com", databaseURL: "https://nasukaapp-default-rtdb.asia-southeast1.firebasedatabase.app", projectId: "nasukaapp", messagingSenderId: "853986671478", appId: "1:853986671478:web:25b1c3f0b72149c5885857" };
    ...
    function initializeUserProfile() {
      ...
      if (!userID) {
  if (namaEl) namaEl.textContent = "Please Log In";
...
// batas terlarang ai tidak boleh menghapus //
    ...
    $(document).ready(function() {
      ...
      // Initialize audio for the first user interaction
...
function login() {
  ...
  // Ambil referensi ke elemen error yang sudah ada di HTML
...
function signup() {
  ...
  ref.get().then(snap => {
    ...
    ref.set({
      ...
      // Update objek localUser
      localUser.Username = u;
      localUser.ID = id;
      localUser.Perak = ii;
      
      // Panggil initializeHome untuk memperbarui UI
      initializeHome();
...
// Tambahkan fungsi showHome jika belum ada
function showHome() {
  ...
  // Tampilkan home container
  document.getElementById('home-container').style.display = 'block';
  
  // Perbarui tampilan perak
  updatePerakDisplay();
}
